...
const Cliente = ({cliente}) =>{
    ...
    const [ eliminarCliente ] = useMutation(ELIMINAR_CLIENTE, {update(cache){
    ...
    return (     
        <tr>
            <td className="border px-4 py_2">{nombre} {apellido}</td>
            <td className="border px-4 py_2">{empresa}</td>
            <td className="border px-4 py_2">{email}</td> 
            <td className="border px-4 py_2">
