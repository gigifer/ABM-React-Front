    ...
    const formik = useFormik({
        ...
        onSubmit: async valores =>{
            ...
            try {
                ...
                // redireccionar al usuario a clientes
                setTimeout(() => {
                    guardarMensaje(null);
                    router.push('/');
                }, 2000);
                    ...
                    <div className="w-full max-w-sm">
                        <form className="bg-white rounded shadow-md px-8 pt-6 pb-8 mb-4" onSubmit={formik.handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                id="email" type="email" placeholder="Email Usuario" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.email}>
                                </input>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <input className="shadow appearence-none border rounded w-full py-2 px-3 text-gray-700 
                                leading-tight focus:outline-none focus:shadow-outline"
                                id="password" type="password" placeholder="Password Usuario" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.password}>
                                </input>
                            </div>
